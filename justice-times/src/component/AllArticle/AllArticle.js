...
export const AllArticle = () => {
	return (
		<div>
			...
			<ArticleList>
				<ArticleCard views="11111" date="Jun 13 · 5 min read" authorName="Anthony J.Yeung" authorImg={authorImg}
										 mainImg={articleImg} tag="#Typography" title="Johannes Gutenberg: The Birth of Movable Johannes"
